...
import 'package:academy_lms_app/features/home/cubit/home_cubit.dart';
              ...
              child: FutureBuilder(
                  ...
                  builder: (ctx, dataSnapshot) {
                    if (dataSnapshot.connectionState ==
                        ...
                        state is LoadingGetSliderAndStories) {
                      return SizedBox(
                        ...
                        return Column(
                          children: [
                            ...
                            cubit.mainStoryAndSliderModel?.stories?.length == 0
                                ...
                                : SizedBox(
                                    height:
                                        120, // Fixed height for the horizontal list
                                    child: ListView.builder(
                                      scrollDirection: Axis.horizontal,
                                      itemCount: cubit.mainStoryAndSliderModel
                                              ?.stories?.length ??
                                          0,
                            ...
                            cubit.mainStoryAndSliderModel?.sliders?.length == 0
                                ...
                                : CarouselSlider(
                                    ...
                                    items: cubit
                                        .mainStoryAndSliderModel?.sliders
                                        ?.map((item) {
                                      return Builder(
                                        builder: (BuildContext context) {
                                          return InkWell(
                                            onTap: () async {
                                              _launchUrl(item.link.toString());
                                            },
                                            child: Container(
